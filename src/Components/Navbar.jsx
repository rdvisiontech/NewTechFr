...
function Navbar() {
  ...
  return (
    <div className="">
      <header
        className={`${
          isDisabled ? "bg-blue-50" : "bg-[#1462dd]"
        } text-white font-semibold body-font h-[120px] flex items-center`}
      >
        {!isDisabled && (
            ...
            <div className="md:flex items-center hidden space-x-8">
              ...
              <nav className="flex space-x-6">
                ...
                <NavLink
                  ...
                  to="/"
                  className={({ isActive }) =>
                    `mx-5 my-1 p-2 rounded-lg transition-all duration-300 ease-in-out hover:bg-[#5b91d2] hover:shadow-lg hover:scale-105 ${
                      isActive ? "bg-[#0d4d9d] text-white" : ""
                    }`
                  }
                >
                  Home
                    ...
                    {dropdownOpen && (
                      <div className="absolute mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg z-50">
                        <NavLink
                          ...
                          to="/post"
                          className={({ isActive }) =>
                            `text-blue-600 block px-4 py-2 rounded-t-lg transition-all duration-300 ease-in-out hover:bg-[#5b91d2] hover:text-white ${
                              isActive ? "bg-[#0d4d9d] text-white" : ""
                            }`
                          }
                        >
                        ...
                        <NavLink
                          ...
                          to="/aplicantList"
                          className={({ isActive }) =>
                            `text-blue-600 block px-4 py-2 transition-all duration-300 ease-in-out hover:bg-[#5b91d2] hover:text-white ${
                              isActive ? "bg-[#0d4d9d] text-white" : ""
                            }`
                          }
                        >
                        ...
                        <NavLink
                          ...
                          to="/score"
                          className={({ isActive }) =>
                            `text-blue-600 block px-4 py-2 rounded-b-lg transition-all duration-300 ease-in-out hover:bg-[#5b91d2] hover:text-white ${
                              isActive ? "bg-[#0d4d9d] text-white" : ""
                            }`
                          }
                        >
              ...
              {localStorage.getItem("loginDetails") ? (
                <button
                  onClick={logOut}
                  className="bg-[#0d4d9d] flex items-center justify-start font-semibold text-white hover:bg-gray-800 border-0 py-1 px-4 rounded hover:scale-105 hover:shadow-lg transition-all"
                >
                  <span>
                ...
                <button
                  ...
                  className={`${
                    localStorage.getItem("loginDetails") ? "bg-[#0d4d9d]" : ""
                  } w-28 font-semibold text-white hover:bg-[#5b91d2] border-0 py-1 px-4 rounded hover:scale-105 hover:shadow-lg transition-all`}
                >
                  Hr Login
                </button>
              )}
        ...
        {menu && (
          <div className="absolute top-[120px] left-0 w-full h-96 bg-[#1462dd] z-[9999] ">
            <ul className="flex flex-col items-center p-5">
              <nav className="flex flex-col text-white text-base ">
                {" "}
                {/* Added space between nav items */}
                <NavLink
                  onClick={toggleMenu}
